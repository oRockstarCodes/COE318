...
//Initialize the instance variables
    ...
    public ComplexNumber multiply(ComplexNumber z) {
        double r = z.getReal(), i = z.getImaginary();
        return new ComplexNumber(real * r - imaginary * i, real * i + imaginary * r);	//A stub: to be fixed
    }
    ...
    public ComplexNumber reciprocal() {
        ...
        return new ComplexNumber(real / d, -imaginary / d);	//A stub: to be fixed
    }
